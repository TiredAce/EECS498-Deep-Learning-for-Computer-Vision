...
def multiples_of_ten(start: int, stop: int) -> Tensor:
    ...
    ##########################################################################
    # Replace "pass" statement with your code
    integers = torch.arange(start, stop + 1)
    
    multiples_of_ten = integers[integers % 10 == 0]
    
#     if multiples_of_ten.numel() == 0:
#         x = torch.tensor([], dtype = torch.float64)
#     else:

    x = multiples_of_ten.to(torch.float64) 
...
def reverse_rows(x: Tensor) -> Tensor:
    ...
    ##########################################################################
    # Replace "pass" statement with your code
    rows = torch.arange(x.shape[0] - 1, -1, -1)
    y = x[rows, :]
    ##########################################################################
    #                            END OF YOUR CODE                            #
    ##########################################################################
...
def reshape_practice(x: Tensor) -> Tensor:
    ...
    print(x.view(2,-1,4))
    print(x.view(2,-1,4).transpose(1,2))
    print(x.view(2,-1,4).transpose(1,2).reshape(8,3))
    ##########################################################################
    #                            END OF YOUR CODE                            #
    ##########################################################################
    return y
